...
namespace DFIS.EntitiesDAL.EDMX
{
    ...
    public partial class GeneralBuildingFacilityDetail
    {
        public int IDBuildingFacilityDetail { get; set; }
        ...
        public virtual MasterDynamicField MasterDynamicField { get; set; }
