(function () {
	...
	ctrl.$inject = ['PPVHSService','$uibModalInstance', 'DataPerlengkapanService', 'item', 'ProvinsiService', 'UIControlService'];
	/* @ngInject */
	function ctrl(PPVHSService, $uibModalInstance, DataPerlengkapanService, item, ProvinsiService, UIControlService) {
		var vm = this;
		vm.dataBuilding = {};
