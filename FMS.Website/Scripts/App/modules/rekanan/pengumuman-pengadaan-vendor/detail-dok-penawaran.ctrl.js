(function () {
	...
	angular.module("app").controller("DetDokPenawaranCtrl", ctrl);
	...
	function ctrl($http, $translate, $translatePartialLoader, $location, SocketService, PengumumanPengadaanService, $state, UploadFileConfigService,
