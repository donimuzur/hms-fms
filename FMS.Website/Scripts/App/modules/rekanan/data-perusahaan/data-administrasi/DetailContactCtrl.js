(function () {
    ...
    angular.module("app").controller("DetailContactAdministrasiCtrl", ctrl);
    ctrl.$inject = ['$http', '$translate', '$translatePartialLoader', '$location', 'SocketService',
        'DataAdministrasiService', 'UIControlService', 'item', '$uibModalInstance', '$uibModal', 'GlobalConstantService', 'VendorRegistrationService'];
    /* @ngInject */
    function ctrl($http, $translate, $translatePartialLoader, $location, SocketService,
        ...
        function savedata() {
            if (vm.Name === '' || vm.Email === '' || vm.Telp === '') {
                UIControlService.msg_growl('error', 'FORM Tidak Lengkap');
                return;
            }
            var data = {
