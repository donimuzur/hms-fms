(function () {
    ...
    angular.module("app").controller("WriteChatBarangVCtrl", ctrl);
       ...
       // vm.jLoad = jLoad;
        ...
        function jLoad(current) {
            ...
            var tend = {
                ...
                TenderStepDataID: vm.step
            }
            NegosiasiBarangService.bychatv(tend, function (reply) {
        ...
        function simpan() {
            ...
            NegosiasiBarangService.insertchatv(data,
               function (reply) {
