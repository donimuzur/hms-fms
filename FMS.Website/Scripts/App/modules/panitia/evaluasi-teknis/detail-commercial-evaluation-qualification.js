(function () {
    ...
    function ctrl($http, $translate, $translatePartialLoader, $location, SocketService, EvaluationQualificationService,
        ...
        vm.kembali = kembali;
        function kembali() {
            $state.transitionTo('equipment-evaluation-qualf-teknis', { TenderRefID: vm.TenderRefID, ProcPackType: vm.ProcPackType, VendorID: vm.VendorID });
        }
        ...
        function gotoDetail(data) {
            ...
            if (data.vendorOffer.DocumentType === "FORM_DOCUMENT") {
                $state.transitionTo('detail-questionnaire-qualf-teknis', { TenderRefID: vm.TenderRefID, ProcPackType: vm.ProcPackType, VendorID: vm.VendorID });
            }
            else {
                var data = {
                    item: data
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: 'app/modules/panitia/temporary/evaluation-qualification/detail-evaluation-qualification.html',
