angular.module('eprocAppPanitia')
        .controller('pemasukanDokumenPraKualifikasiCtrl', function($state, $scope, $http, $rootScope, $cookieStore, $stateParams) {
            ...
            $scope.lihatProfil = function(rekanan_id) {
                ...
                $state.transitionTo('detail-penetapan-hasil-prakualifikasi', {
                    flowpaket_id: flowpaket_id,
                    paket_lelang_id: $scope.paket_lelang_id
                });
            };
