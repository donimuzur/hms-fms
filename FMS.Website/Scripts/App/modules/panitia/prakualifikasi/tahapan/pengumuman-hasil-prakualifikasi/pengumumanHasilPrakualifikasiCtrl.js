angular.module('eprocAppPanitia')
        .controller('detailPengumumanHasilPraKualifikasiCtrl', function($state, $scope, $http, $rootScope, $cookieStore, $stateParams) {
            
        })
        .controller('pengumumanHasilPraKualifikasiCtrl', function($state, $scope, $http, $rootScope, $cookieStore, $stateParams) {
            ...
            $scope.lihatProfil = function(rekanan_id) {
                ...
                $state.transitionTo('detail-pengumumanhasil-prakualifikasi', {
