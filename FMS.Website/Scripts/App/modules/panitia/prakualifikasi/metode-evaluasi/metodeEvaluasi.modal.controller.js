(function () {
    ...
    ctrl.$inject = ['$http', '$state', '$stateParams', '$uibModalInstance', '$translate', '$translatePartialLoader', '$location', 'SocketService', 'MetodeEvaluasiPrakualService', 'UIControlService', 'item'];
    /* @ngInject */
    function ctrl($http, $state, $stateParams, $uibModalInstance, $translate, $translatePartialLoader, $location, SocketService, metodeEvaluasiPrakualService, UIControlService, item) {
        ...
        function initialize() {
            ...
            metodeEvaluasiPrakualService.selectDCByMethod({
                EvaluationMethodId: metode_evaluasi_id
            }, function (reply) {
