(function () {
    ...
    angular.module("app")
    .controller("aturSubCostEstimateTCCtrl", ctrl);
    ...
    function ctrl($state, $scope, $http, $filter, $stateParams, $uibModal, $translate, $translatePartialLoader, $location, SocketService, DataContractRequisitionService, RequisitionListService, UIControlService) {
        ...
        vm.breadcrumbs = [
            ...
            { title: "BREADCRUMB.DETAIL_COST_ESTIMATE", href: "#/requisition-list/detail-contract-requisition/detail-cost-estimate/" + $stateParams.contractRequisitionId },
        ...
        vm.back = back;
        function back() {
            $state.transitionTo('detail-cost-estimate-tc', { contractRequisitionId: contractRequisitionId });
        };
    }
})();