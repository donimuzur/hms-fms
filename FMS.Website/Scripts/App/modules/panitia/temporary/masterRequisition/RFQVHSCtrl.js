angular.module('eprocAppPanitia').controller('RFQVHSCtrl', function ($scope, $http, $rootScope, $modal, $cookieStore) {
    $scope.totalItems = 0;
    $scope.currentPage = 0;
    $scope.maxSize = 10;
    $scope.Pegawais = [];
...
var modalitemUpload = function ($scope, $modalInstance, $http, item, $rootScope, $modal) {
    $scope.cancel = function () {
        $modalInstance.dismiss('cancel');
    };
    //$scope.
...
var addModalRFQ = function ($scope, $modalInstance, $http, item, $rootScope, $modal) {
    ...
    $scope.itemUpload = function (size) {
        var item = {userId: $scope.userId};
        var modalInstance = $modal.open({
            templateUrl: 'itemUpload.html',
            controller: modalitemUpload,
            size: size,
            resolve: {item: function () {
                    return item;
                }}
