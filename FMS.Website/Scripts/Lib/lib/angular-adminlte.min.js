...
angular.module('admin-lte-angular.templates', []).run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put("sidebar-menu/template.tpl.html",
      ...
      "        <a ng-switch-when=\"false\" ui-sref=\"{{::item.state}}\" ng-if=\"item.state\">\n" +
      "            <i class=\"fa\" ng-class=\"item.iconClass\"></i>\n" +
      "            <span>{{::item.title | translate}}</span>\n" +
      "            <small class=\"badge pull-right\" ng-class=\"item.badgeClass\" ng-show=\"item.hasBadge\">{{item.badge}}</small>\n" +
      "        </a>\n" +
      "        <a ng-switch-when=\"false\" href=\"\" ng-if=\"!item.state\">\n" +
      "            <i class=\"fa\" ng-class=\"item.iconClass\"></i>\n" +
      "            <span>{{::item.title | translate}}</span>\n" +
      "            <small class=\"badge pull-right\" ng-class=\"item.badgeClass\" ng-show=\"item.hasBadge\">{{item.badge}}</small>\n" +
      "        </a>\n" +
      ...
      "            <i class=\"fa\" ng-class=\"item.iconClass\"></i>\n" +
      "            <span>{{::item.title | translate}}</span>\n" +
      "            <i class=\"fa pull-right\" ng-class=\"{ 'fa-angle-down': item.expanded, 'fa-angle-left': !item.expanded }\"></i>\n" +
      "            <ul class=\"treeview-menu\" ng-show=\"item.expanded\">\n" +
      "                <li  ng-repeat=\"sub in item.submenu\"  ng-switch=\"sub.hasSubmenu\" ng-class=\"{'treeview': !sub.hasSubmenu}\" >\n" +
      "                     <a ng-switch-when=\"false\" ui-sref=\"{{::sub.state}}\" ng-if=\"sub.state\">\n" +
      "                     <i class=\"fa\" ng-class=\"sub.iconClass\"></i>\n" +
      "                     <span>{{::sub.title | translate}}</span>\n" +
      "                     <i class=\"fa\" ng-class=\"sub.IsChecked\"></i>\n" +
      "                     <small class=\"badge pull-right\" ng-class=\"sub.badgeClass\" ng-show=\"sub.hasBadge\">{{sub.badge}}</small>\n" +
      "                     </a>\n" +
      "                     <a ng-switch-when=\"false\" href=\"\" ng-if=\"!sub.state\">\n" +
      "                     <i class=\"fa\" ng-class=\"sub.iconClass\"></i>\n" +
      "                     <span>{{::sub.title | translate}}</span>\n" +
      "                     <small class=\"badge pull-right\" ng-class=\"sub.badgeClass\" ng-show=\"sub.hasBadge\">{{sub.badge}}</small>\n" +
      "                     </a>\n" +
      "                     <a ng-switch-when=\"true\" ng-click=\"sub.expanded = !sub.expanded\">\n" +
      "                     <i class=\"fa\" ng-class=\"sub.iconClass\"></i>\n" +
      "                     <span>{{::sub.title | translate}}</span>\n" +
      "                     <i class=\"fa pull-right\" ng-class=\"{ 'fa-angle-down': sub.expanded, 'fa-angle-left': !sub.expanded }\"></i>\n" +
      "                     <ul class=\"treeview-menu\" ng-show=\"sub.expanded\">\n" +
      "                         <li class=\"treeview\" ng-repeat=\"subitem in sub.submenu\" ui-sref-active=\"active\">\n" +
      "                         <a ng-if=\"subitem.state\"  ui-sref=\"{{::subitem.state}}\"><i class=\"fa\" ng-class=\"subitem.iconClass\"></i> {{::subitem.title | translate}}</a>\n" +
                                "<a ng-if=\"!subitem.state\" href=\"\"><i class=\"fa\" ng-class=\"subitem.iconClass\"></i> {{::subitem.title | translate}}</a>\n" +
...
(function () {
    ...
    angular.module("admin-lte-angular").directive("altaSidebarMenu", function ($http) {
        return {
            restrict: "EA",
            scope: {
                menuItems: "="
            ...
            link: function (scope, element, attrs) {
                    ...
                    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                        ...
                        if (item.hasSubmenu) {
                            ...
                            for (var j = 0; j < subitems.length; j++) {
                                var sub = subitems[j];
                                var _sub;
                                sub.hasSubmenu = (sub.submenu != null) && ((_sub = sub.submenu) != null ? _sub.length : void 0) > 0;
                                sub.expanded = false;
                                sub.hasBadge = !(sub.badge == null);
                                updated.push(sub);
                            }
                            item.submenu = updated;
                        }

                    }
                    console.log('Load directive with menu Items: ' + JSON.stringify(scope.menuItems));
                }
                ...
                scope.$watch(attrs, function (newValue, oldValue) {
                    ...
                    console.log("Menus: " + scope.menuItems);
                    if (scope.menuItems && scope.menuItems.length > 0) {
                        update(scope.menuItems);
                    }
                })
