...
namespace FMS.Website.Controllers
{
    public class TraTemporaryController : BaseController
    {
        ...
        public void GetListTempInProgress()
        {
            try
            {
                var ListTemp = _tempBLL.GetList().Where(x => x.DOCUMENT_STATUS == Enums.DocumentStatus.InProgress &&
                ...
                foreach (var VendorItem in Vendor)
                {
                    ...
                    IsSend = _tempBLL.BatchEmailTemp(reListTempDto, VendorItem, AttacthmentWtc, AttacthmentBenefit);
