...
{
    public class RptCCFMapper
    {
        public static void Initialize()
        {
            AutoMapper.Mapper.CreateMap<TRA_CCF, RptCCFDto>().IgnoreAllNonExisting()
                .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.TRA_CCF_ID))
            ...
            AutoMapper.Mapper.CreateMap<RptCCFDto, TRA_CCF>().IgnoreAllNonExisting()
               .ForMember(dest => dest.TRA_CCF_ID, opt => opt.MapFrom(src => src.Id))
