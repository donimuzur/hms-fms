...
namespace FMS.BLL.Mapper
{
    public class CafMapper
    {
        public static void Initialize()
        {
            ...
            AutoMapper.Mapper.CreateMap<ARCH_TRA_CAF, TraCafDto>().IgnoreAllNonExisting()
                .ForMember(dest => dest.TraCafId, opt => opt.MapFrom(src => src.TRA_CAF_ID))
                .ForMember(dest => dest.Area, opt => opt.MapFrom(src => src.AREA))
                .ForMember(dest => dest.CreatedBy, opt => opt.MapFrom(src => src.CREATED_BY))
                .ForMember(dest => dest.CreatedDate, opt => opt.MapFrom(src => src.CREATED_DATE))
            ...
            AutoMapper.Mapper.CreateMap<TraCafDto, ARCH_TRA_CAF>().IgnoreAllNonExisting()
                .ForMember(dest => dest.TRA_CAF_ID, opt => opt.MapFrom(src => src.TraCafId))
                .ForMember(dest => dest.AREA, opt => opt.MapFrom(src => src.Area))
                .ForMember(dest => dest.CREATED_BY, opt => opt.MapFrom(src => src.CreatedBy))
                .ForMember(dest => dest.CREATED_DATE, opt => opt.MapFrom(src => src.CreatedDate))
            ...
            AutoMapper.Mapper.CreateMap<TraCafProgressDto, ARCH_TRA_CAF_PROGRESS>().IgnoreAllNonExisting()
                .ForMember(dest => dest.TRA_CAF_ID, opt => opt.MapFrom(src => src.TraCafId))
                .ForMember(dest => dest.ACTUAL, opt => opt.MapFrom(src => src.Actual))
                .ForMember(dest => dest.CREATED_BY, opt => opt.MapFrom(src => src.CreatedBy))
                .ForMember(dest => dest.CREATED_DATE, opt => opt.MapFrom(src => src.CreatedDate))
                ...
                .ForMember(dest => dest.STATUS_ID, opt => opt.MapFrom(src => src.StatusId))
                ;
            AutoMapper.Mapper.CreateMap<ARCH_TRA_CAF_PROGRESS, TraCafProgressDto>().IgnoreAllNonExisting()
                .ForMember(dest => dest.TraCafId, opt => opt.MapFrom(src => src.TRA_CAF_ID))
                .ForMember(dest => dest.Actual, opt => opt.MapFrom(src => src.ACTUAL))
                .ForMember(dest => dest.CreatedBy, opt => opt.MapFrom(src => src.CREATED_BY))
                .ForMember(dest => dest.CreatedDate, opt => opt.MapFrom(src => src.CREATED_DATE))
