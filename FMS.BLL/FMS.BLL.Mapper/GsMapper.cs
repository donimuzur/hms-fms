        ...
        public static void Initialize()
        {
            ...
            AutoMapper.Mapper.CreateMap<GsDto, MST_GS>().IgnoreAllNonExisting()
             .ForMember(dest => dest.MST_GS_ID , opt => opt.MapFrom(src => src.MstGsId))
                ...
                .ForMember(dest => dest.GS_MANUFACTURER, opt => opt.MapFrom(src => src.GsManufacturer))
                .ForMember(dest => dest.GS_MODEL, opt => opt.MapFrom(src => src.GsModel))
                .ForMember(dest => dest.GS_SERIES, opt => opt.MapFrom(src => src.GsSeries))
                .ForMember(dest => dest.GS_TRANSMISSION, opt => opt.MapFrom(src => src.GsTransmission))
