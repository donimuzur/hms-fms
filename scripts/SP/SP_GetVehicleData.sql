ALTER procedure [dbo].[GetVehicleData]
AS BEGIN
	...
	USING (
		...
		PO_LINE, CREATED_DATE,CAR_GROUP_LEVEL,VEHICLE_YEAR,VEHICLE_USAGE,PROJECT,PROJECT_NAME,GROUP_LEVEL,ASSIGNED_TO,
		ADDRESS,START_DATE,CERTIFICATE_OWNERSHIP,COMMENTS FROM MST_FLEET
	) AS Source
	...
	WHEN NOT MATCHED BY TARGET THEN
		...
		PO_LINE, REPORT_MONTH, REPORT_YEAR, CREATED_DATE,CAR_GROUP_LEVEL,VEHICLE_YEAR,VEHICLE_USAGE,PROJECT,PROJECT_NAME,EMPLOYEE_GROUP_LEVEL,ASSIGNED_TO,
		ADDRESS,START_DATE,CERTIFICATE_OF_OWNERSHIP,COMMENTS)
		...
		, Source.PO_NUMBER, Source.PO_LINE, MONTH(Source.CREATED_DATE), YEAR(Source.CREATED_DATE), Source.CREATED_DATE, Source.CAR_GROUP_LEVEL
		, Source.VEHICLE_YEAR, Source.VEHICLE_USAGE, Source.PROJECT, Source.PROJECT_NAME, Source.GROUP_LEVEL, SOURCE.ASSIGNED_TO, SOURCE.ADDRESS
		, SOURCE.START_DATE, SOURCE.CERTIFICATE_OWNERSHIP, SOURCE.COMMENTS)
	WHEN MATCHED THEN
		UPDATE SET
