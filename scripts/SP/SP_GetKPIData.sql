USE [FMS_HMS]
GO
/****** Object:  StoredProcedure [dbo].[GetKPIData]    Script Date: 12/18/2017 10:26:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[GetKPIData]
AS BEGIN
	...
	USING (
		...
		WHERE C.DOCUMENT_STATUS = 11
		AND UPPER(C.VEHICLE_TYPE) = 'BENEFIT'
	) AS Source
