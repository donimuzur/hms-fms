...
AS BEGIN
	...
	WHEN NOT MATCHED BY TARGET THEN
		...
		Source.VEHICLE_USAGE, Source.LOCATION, REPORT_MONTH, REPORT_YEAR, (Source.REPORT_YEAR + Source.REPORT_MONTH), Source.REGION)
	WHEN MATCHED THEN
	UPDATE SET POLICE_NUMBER = Source.POLICE_NUMBER,
			...
			CREATED_DATE = (Source.REPORT_YEAR + Source.REPORT_MONTH),
