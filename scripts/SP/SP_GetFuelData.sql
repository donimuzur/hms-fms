...
AS BEGIN
	...
	USING (
		select FO.POLICE_NUMBER, FO.LITER, MAX(FO.LAST_KM) AS ODOMETER, FO.COST, FL.FUEL_TYPE, FL.COST_CENTER, 
		FL.VEHICLE_FUNCTION, FL.MANUFACTURER, FL.MODEL, FL.SERIES, FL.BODY_TYPE, FL.VEHICLE_TYPE, FL.VEHICLE_USAGE, 
		LM.BASE_TOWN, FO.CREATED_DATE, FL.MST_FLEET_ID
	...
	WHEN NOT MATCHED BY TARGET THEN
		...
		VALUES( Source.POLICE_NUMBER, Source.LITER, Source.ODOMETER, Source.COST, Source.FUEL_TYPE, Source.COST_CENTER, 
		Source.VEHICLE_FUNCTION, Source.MANUFACTURER, Source.MODEL, Source.SERIES, Source.BODY_TYPE, Source.VEHICLE_TYPE, 
		Source.VEHICLE_USAGE, Source.BASE_TOWN, MONTH(Source.CREATED_DATE), 
		YEAR(Source.CREATED_DATE), Source.CREATED_DATE, Source.MST_FLEET_ID);
