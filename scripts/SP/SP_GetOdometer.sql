...
AS BEGIN
	...
	USING (
		select FO.LAST_KM, MAX(FO.LAST_KM) AS TOTAL_KM, FO.VEHICLE_TYPE, CC.FUNCTION_NAME, LM.REGION, FO.CREATED_DATE 
	...
	WHEN NOT MATCHED BY TARGET THEN
		...
		VALUES( Source.TOTAL_KM - Source.LAST_KM, Source.VEHICLE_TYPE, Source.FUNCTION_NAME, Source.REGION, MONTH(Source.CREATED_DATE), 
